...
typedef enum
{
nrf_TIMER_MODE_SINGLE_SHOT, //执行一次
nrf_TIMER_MODE_REPEATED //周期执行
} nrf_timer_mode_d;
...
uint32_t nrf_drv_timer_create(nrf_timer_mode_d   mode);
...
//															uint32_t nrf_drf_timer_create(
//                                           drf_timer_mode_d     mode);
/**
